...
public class ControllerServlet extends HttpServlet {
	...
	private String checkAuthorization(HttpServletRequest req, String action) {
		// Login and Logout do not need authorization
	...
	private void injectUserIfRequested(Command command, HttpServletRequest req) {
		try {
			// Look for setUser(User) method using reflection
			...
			// Command doesn't request user injection - this is fine, it's optional
