...
<body>
	...
	<section>
		<article id="a01" style="text-align: center; padding: 20px;">
			...
			<p style="color: red; background-color: white; opacity: 1;">
				${sessionScope.user.username} does not have permission to access the
				requested resource.</p>
			<br /> <a href="index.jsp">Go to Start Page</a>
		</article>
	</section>
	<footer>
